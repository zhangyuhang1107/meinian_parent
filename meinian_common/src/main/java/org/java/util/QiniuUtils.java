...
public class QiniuUtils {
    ...
    public static String accessKey = "FVsZVx0HsN6LIXbCcVaFC7xFsMAaetvYWzsZoapj";
    public static String secretKey = "U-rdmDlr3cFe-U4qkfhQOK_LPOB4nRpepF5_AnAn";
    public static String bucket = "meinian-zyh";
